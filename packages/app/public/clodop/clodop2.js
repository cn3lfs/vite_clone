      ...
      list: [
        {
          ...
          PortName:
            'Microsoft.Office.OneNote_16001.12827.20182.0_x64__8wekyb3d8bbwe_microsoft.onenoteim_S-1-5-21-3339568339-1808528086-67062071-1002',
          Orientation: '1',
          PaperSize: '9',
          PaperLength: '2970',
          PaperWidth: '2100',
          ...
          pagelist: [{ name: '信纸' }, { name: 'A4' }],
          subdevlist: []
        },
        {
          name: 'ZH3080(标签)',
          DriverName: 'Gprinter A83I(Label)',
          PortName: 'USB001',
          Orientation: '1',
          PaperSize: '256',
          PaperLength: '600',
          ...
          Color: '1',
          Duplex: '1',
          FormName: 'User defined',
          Comment: '',
          DriverVersion: '1024',
          DCOrientation: '90',
          MaxExtentWidth: '1180',
          MaxExtentLength: '10360',
          MinExtentWidth: '10',
          MinExtentlength: '10',
          pagelist: [{ name: 'User defined' }],
          subdevlist: []
        },
        {
          name: 'NPIC68BD8 (HP LaserJet Professional M1216nfh MFP)',
          DriverName: 'HP LaserJet Mono PCLmS Class Driver',
          PortName: 'IP6_M1216nfh_NPIC68BD8_INZOT_75D9B',
          Orientation: '1',
          PaperSize: '9',
          PaperLength: '2970',
          PaperWidth: '2100',
      ...
      for (var iDrvNO in this.Printers['list']) {
        if (
          ...
          for (var iBdgNO in this.Printers['list'][iDrvNO]['subdevlist']) {
            var BridgeID = this.Printers['list'][iDrvNO]['subdevlist'][iBdgNO]
              .id
            var BridgeName = this.Printers['list'][iDrvNO]['subdevlist'][iBdgNO]
              .name
            if (
